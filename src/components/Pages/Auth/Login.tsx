        ...
        <Authenticated>
            ...
            <div className="w-11/12 md:w-inherit  bg-white md:bg-inherit mx-6 md:mx-0 rounded-lg">
                <div className=" flex flex-col justify-center items-center p-6  sm:p-6 md:p-12 rounded-lg ">
                    <p className="text-fontBlack text-base sm:text-xl  font-redHatDisplayBold flex items-center gap-2 mb-2">
                        Welcome to <span className="text-gradient font-redHatDisplayBlack text-lg sm:text-2xl">DUVET ADMIN PANEL</span>
                    </p>
                    ...
                    >
                        ...
                        <div className="font-redHatDisplayBold flex justify-between items-center ">
                            <CustomCheckbox
                            ...
                            <div>
                                <Link
                                    className="text-fontBlack text-xs sm:text-sm"
                                    to="/forgot-password"
                                >
                                    Forgot Password ?
                                </Link>
