...
const CommonDatepicker: React.FC<Props> = ({
    ...
    return (
        <div
            className={` w-full bg-white  rounded-lg custom-date-picker relative datepicker font-redHatDisplayRegular ${
                error ? 'error-state' : ''
            }`}
        >
            <LocalizationProvider dateAdapter={AdapterDateFns}>
                <DatePicker
                    ...
                    renderInput={(params) => (
                        <TextField
                            sx={{ backgroundColor: bgcolor ?? 'transparent', fontFamily: "RedHatDisplay Regular", }}
                            label={label}
                            onKeyDown={(e) => {
                                e.preventDefault()
                            }}
