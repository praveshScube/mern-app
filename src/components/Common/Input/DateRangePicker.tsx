...
export const DateRangePicker: React.FC<Props> = ({
  ...
  //  <ClickAwayListener onClickAway={()=>setOpen(false)}>
     <div className={`bg-white h-12 sm:h-14 px-2 flex justify-between rounded-lg items-center gap-2 sm:gap-5 date-range-picker  border hover:border-2 cursor-pointer hover:border-WaterBlue  border-[#E7E8ED] ${error ?'input-error':''}`}>
      <div>
        <label
          htmlFor={label}
